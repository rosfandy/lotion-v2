...
export const ColTableTools = ({ parentRef, editor }: Props) => {
  ...
  return (
    <>
      <div
        ref={toolRef}
        className="text-sm min-w-[200px] bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-lg shadow-lg p-2 flex flex-col gap-1"
      >
        <button
          type="button"
        ...
        >
          <TbColumnInsertLeft size={20} className="flex-shrink-0" />
        ...
        >
          <TbColumnInsertRight size={20} className="flex-shrink-0" />
        ...
        >
          <TbColumnRemove size={20} className="flex-shrink-0" />
